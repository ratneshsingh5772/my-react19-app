...
const BankAccounts = () => {
    ...
    return (
        <div className="relative overflow-hidden bg-linear-to-br from-slate-50 via-blue-50/30 to-indigo-50 rounded-3xl shadow-2xl border border-gray-200/50 p-8 md:p-10 my-8 max-w-lg mx-auto">
            ...
            {lastAction && (() => {
                let actionBgClass;
                if (lastAction.type === 'deposit') actionBgClass = 'bg-green-100 border-green-400 text-green-700';
                else if (lastAction.type === 'withdraw') actionBgClass = 'bg-red-100 border-red-400 text-red-700';
                else actionBgClass = 'bg-gray-100 border-gray-400 text-gray-700';
                return (
