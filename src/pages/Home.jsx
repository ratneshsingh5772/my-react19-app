    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Build amazing web applications with React 19 and modern tools.
              Fast, reliable, and beautiful user experiences.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600">Built with modern technologies for optimal performance and speed.</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600">Enterprise-grade reliability with robust error handling and testing.</p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition duration-300">
              ...
              <p className="text-gray-600">Beautiful, responsive design that works perfectly on all devices.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Interactive Counter Component</h2>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">User Profiles</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Meet our team members and see their current status.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-6">
            {/* Instance 1: Passing strings, numbers, and booleans */}
            <UserCard 
              name="Alice Johnson" 
            ...
            {/* Instance 2: Reuse the same component with different data */}
            <UserCard 
              name="Bob Smith" 
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">MyReactApp</h3>
            ...
            <div className="flex justify-center space-x-6">
              ...
              <button className="text-gray-400 hover:text-white transition duration-300" aria-label="GitHub">
